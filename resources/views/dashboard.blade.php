                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 ">
                            ...
                            <tbody>
                                @foreach (App\Models\Complaint::where(['status'=>'in progress'])->get() as $key =>
                                $item)
                                <tr>
                                    ...
                                    <td class="text-xs font-weight-bold mb-0">
                                        ...
                                        <span class="badge bg-primary mx-o">{{$item->status}}</span>
                                        @endif
                                    </td>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 ">
                            ...
                            <tbody>
                                @foreach (App\Models\Complaint::where(['status'=>'closed'])->get() as $key =>
                                $item)
                                <tr>
                                    ...
                                    <td class="text-xs font-weight-bold mb-0">
                                        ...
                                        <span class="badge bg-success mx-o">{{$item->status}}</span>
                                        @endif
                                    </td>
